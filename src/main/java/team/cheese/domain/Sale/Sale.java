...
public class Sale {
    ...
    public String getBuyyer_id() {
        return buyyer_id;
    }

    public void setBuyyer_id(String buyyer_id) {
        this.buyyer_id = buyyer_id;
    }
