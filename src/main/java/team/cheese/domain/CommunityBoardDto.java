...
public class CommunityBoardDto {
    ...
    public CommunityBoardDto(String ur_id, String addr_cd, Integer addr_no, String commu_cd, String name, String addr_name, String title, String contents, String nick, String img_full_rt) {
        this.ur_id = ur_id;
        this.addr_cd = addr_cd;
        this.addr_no = addr_no;
        this.commu_cd = commu_cd;
