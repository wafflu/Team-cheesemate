...
public class QnaDaoImpl implements QnaDao {
    ...
    @Override
    public List<QnaDto> selectPageByUserId(Map map) {
        return session.selectList(namespace + "selectPageByUserId", map);
    }

    @Override
    public int countQnasByUserId(String ur_id) {
        return session.selectOne(namespace + "countQnasByUserId", ur_id);
    }
}
