...
//        for(int i=0; i <10; i++) {
//            dto = new ReviewCommentDTO("1",i+1+"",i+1+"","맛있어요",1);
//            rvService.write(dto);
//        }
...
//        rvService.remove("1",b1,r1);
//        rvService.remove("1",b2,r2);
//        // assert : 행이 8개인 것을 확인
...
//        ReviewCommentDTO dto = null;
//        for(int i=0; i <100; i++) {
//            dto = new ReviewCommentDTO("1",i+1+"",i+1+"","맛있어요",2);
//            rvService.write(dto);
//        }
...
//        for(int i=0; i<20; i++) {
//            ReviewCommentDTO r1 = new ReviewCommentDTO("1",i+1+"",i+1+"","맛있어요",2);
//            rvService.write(r1);
//        }
//    }
//    @Test
...
//        UserInfoDTO u1 = new UserInfoDTO("1","1","안녕하세요");
//        assertTrue(userInfoDao.insert(u1)==1);
//        assertTrue(userInfoDao.count()==1);
//        // do : 소개글에 대한 후기글 1개 작성
//        rvDao.deleteAll("1");
//        assertTrue(rvService.getCount("1")==0);
//        ReviewCommentDTO r1 = new ReviewCommentDTO("1","2","2","맛있어요",3);
//       rvService.write(r1);
...
//        assertTrue(rvService.getCount("1")==1);
//        r1 = new ReviewCommentDTO("1","3","3","맛있어요",1);
//        rvService.write(r1);
//        assertTrue(rvService.getCount("1")==2);
//        r1 = new ReviewCommentDTO("1","4","4","맛있어요",1);
//        rvService.write(r1);
...
//        // do : 소개글에 대한 후기글 1개 작성
//        assertTrue(rvService.getCount("1")==3);
//        r1 = new ReviewCommentDTO("1","5","5","맛있어요",3);
//        rvService.write(r1); // 예외 발생
...
//        rvDao.deleteAll("1");
//        assertTrue(rvService.getCount("1")==0);
//        ReviewCommentDTO r1 = new ReviewCommentDTO("1","2","2","맛있어요",1);
//        rvService.write(r1);
//        assertTrue(rvService.getCount("1")==1);
//        // assert : 소개글에 후기글수가 1 증가했는지 확인 & 후기글의 소개글 사용자아이디가 일치하는지 확인
//        assertTrue(userInfoDao.select("1").getRv_cmt_cnt()==1);
...
//        // do : 후기글 삭제
//        Integer no = r1.getNo();
//        rvService.remove(r1.getSal_id(),r1.getBuy_id(),no);
...
//        assertTrue(rvService.getCount("1")==0);
//        ReviewCommentDTO dto = null;
//        dto = new ReviewCommentDTO("1","1","1","맛있어요",1);
//        rvService.write(dto);
//        assertTrue(rvService.getCount("1")==1);
//        dto = new ReviewCommentDTO("1","2","2","맛있어요",1);
//        rvService.write(dto);
//        assertTrue(rvService.getCount("1")==2);
//        ReviewCommentDTO dto1 = new ReviewCommentDTO("1","1","1","맛있어요22",1);
//        ReviewCommentDTO dto2 = new ReviewCommentDTO("1","2","2","맛있어요22",1);
...
//        //      & 후기글 2개 업데이트
//        rvService.modify(dto1);
//        rvService.modify(dto2);
//        assertTrue(rvService.getCount("1")==2);
