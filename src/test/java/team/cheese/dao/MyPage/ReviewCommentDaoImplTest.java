...
public class ReviewCommentDaoImplTest {
    ...
    public void insert() throws Exception {
        ...
        // do : 25개 후기글 insert
        for(int i=25; i <50; i++) {
            dto = new ReviewCommentDTO("1",i+1+"",i+1+"","맛있어요",3);
            assertTrue(rvdao.insert(dto)==1);
        }
        // assert : 50개인지 확인
    ...
    public void update() throws Exception{
        ...
        assertTrue(rvdao.count("1")==0);
        ReviewCommentDTO dto = null;
        dto = new ReviewCommentDTO("1","1","1","맛있어요",2);
        assertTrue(rvdao.insert(dto)==1);
        assertTrue(rvdao.count("1")==1);
        dto = new ReviewCommentDTO("1","2","2","맛있어요",2);
        assertTrue(rvdao.insert(dto)==1);
        assertTrue(rvdao.count("1")==2);
        ReviewCommentDTO dto1 = new ReviewCommentDTO("1","1","1","맛있어요22",3);
        ReviewCommentDTO dto2 = new ReviewCommentDTO("1","2","2","맛있어요22",3);
...
//        ReviewCommentDTO dto = null;
//        for(int i=0; i <10; i++) {
//            dto = new ReviewCommentDTO("1",i+1+"",i+1+"","맛있어요",4);
//            assertTrue(rvdao.insert(dto)==1);
//        }
//        assertTrue(rvdao.count("1")==10);
